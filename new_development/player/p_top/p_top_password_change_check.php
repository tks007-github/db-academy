<!-- 
    ...
    問題なし→p_top_password_change_done.phpへリダイレクト
    問題あり→p_top_password_change.phpへリダイレクト
 -->
...
// p_top_password_change.phpからplayer_passwordとnew_player_passwordとnew_player_password2を受け取る
...
if ($flg) {             // 入力に問題がなかった場合
    ...
    header('Location:p_top_password_change_done.php');          // p_top_password_change_done.phpへリダイレクト
    exit();
} else {                // 入力に問題があった場合
    print '<br>';
    print '<input type="button" onclick="location.href=\'p_top_password_change.php\'" value="戻る">';
}
