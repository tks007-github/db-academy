...
<head>
    ...
    <script src="c_phisical_test_done_player_result.js"></script>
...
<body>
    ...
    // c_phisical_test_contentからの情報をSESSIONで受け取る
    $date = $_SESSION['date'];
...
<button onclick="window.print()">印刷</button>
    <br><br>
    <input type="button" onclick="location.href='c_phisical_test_done_player_list.php'" value="戻る">
