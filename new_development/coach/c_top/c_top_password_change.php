<!-- 
    コーチのパスワード変更画面です。
    現在のパスワード(coach_password)と新しいパスワード(new_coach_password)、新しいパスワード確認(new_coach_password2)の
    入力を求める。
    ＯＫボタンでc_top_password_change_check.phpへ遷移。
 -->
...
<head>
    ...
    <title>c_top_password_change.php</title>
</head>
<body>
    ...
    <form method="post" action="c_top_password_change_check.php">
