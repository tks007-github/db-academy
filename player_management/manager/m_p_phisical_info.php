...
<body>
    ...
    try {
        ...
        if ($rec == false) {                  // データベースからの問い合わせ結果がない場合
            ...
            print '<input type="button" onclick="location.href=\'m_p_phisical_add.php\'" value="登録">';
            ...
            print '<br><br>';
            print '<input type="button" onclick="location.href=\'m_p_top.php\'" value="戻る">';
            print '<input type="button" onclick="location.href=\'m_p_phisical_info_add.php\'" value="登録">';
            print '<input type="button" onclick="location.href=\'m_p_phisical_info_list.php\'" value="一覧">';
            print '<input type="button" onclick="location.href=\'m_p_phisical_info_graph.php\'" value="グラフ">';
        }
    } catch (Exception $e) {
        exit();
    }
