...
<body>
    ...
    <!-- レーダーチャート -->
    <canvas id="myRaderChart1"></canvas>
    <canvas id="myRaderChart2"></canvas>
    　
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.bundle.js"></script>

    <script>
        let ctx1 = document.getElementById("myRaderChart1");
        let ctx2 = document.getElementById("myRaderChart2");
        ...
        let myRadarChart1 = new Chart(ctx1, {
            type: 'radar',
            data: {
