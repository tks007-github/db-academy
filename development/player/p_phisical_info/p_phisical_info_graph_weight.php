...
<body>
    ...
    try {
        ...
        $this_year_avg_weight_arr = [];
        $last_year_avg_weight_arr = [];
        ...
        $json_this_year_weight = json_encode($this_year_avg_weight_arr);
        $json_last_year_weight = json_encode($last_year_avg_weight_arr);
    } catch (Exception $e) {
        var_dump($e);
        exit();
    }
    ...
    <script>
        ...
        let js_this_year_weight = <?php print $json_this_year_weight; ?>;
        let js_last_year_weight = <?php print $json_last_year_weight; ?>;
        ...
        let myLineChart = new Chart(canvas, {
            ...
            data: {
                ...
                datasets: [{
                    label: '今年度',
                    data: [js_this_year_weight[0], js_this_year_weight[1], js_this_year_weight[2],
                        js_this_year_weight[3], js_this_year_weight[4], js_this_year_weight[5],
                        js_this_year_weight[6], js_this_year_weight[7], js_this_year_weight[8],
                ...
                {
                    label: '昨年度',
                    data: [js_last_year_weight[0], js_last_year_weight[1], js_last_year_weight[2],
                        js_last_year_weight[3], js_last_year_weight[4], js_last_year_weight[5],
                        js_last_year_weight[6], js_last_year_weight[7], js_last_year_weight[8],
