...
<body>
    ...
    try {
        ...
        $this_year_avg_body_fat_arr = [];
        $last_year_avg_body_fat_arr = [];
        ...
        for ($i = 0; $i < 9; $i++) {
            ...
            if ($rec == '') {
                $this_year_avg_body_fat_arr[] = NULL;
            } else {
                $this_year_avg_body_fat_arr[] = $rec['grouping_body_fat'];
            }
        }
        // 今年分(1月～3月)
        for ($i = 0; $i < 3; $i++) {
        ...
        for ($i = 0; $i < 9; $i++) {
            ...
            if ($rec == '') {
                $last_year_avg_body_fat_arr[] = NULL;
            } else {
                $last_year_avg_body_fat_arr[] = $rec['grouping_body_fat'];
            }
        }
        // 昨年分(1月～3月)
        for ($i = 0; $i < 3; $i++) {
        ...
        $json_this_year_body_fat = json_encode($this_year_avg_body_fat_arr);
        $json_last_year_body_fat = json_encode($last_year_avg_body_fat_arr);
    } catch (Exception $e) {
        var_dump($e);
        exit();
    }
    ...
    <script>
        ...
        let js_this_year_body_fat = <?php print $json_this_year_body_fat; ?>;
        let js_last_year_body_fat = <?php print $json_last_year_body_fat; ?>;
        ...
        let myLineChart = new Chart(canvas, {
            ...
            data: {
                ...
                datasets: [{
                    label: '今年度',
                    data: [js_this_year_body_fat[0], js_this_year_body_fat[1], js_this_year_body_fat[2],
                        js_this_year_body_fat[3], js_this_year_body_fat[4], js_this_year_body_fat[5],
                        js_this_year_body_fat[6], js_this_year_body_fat[7], js_this_year_body_fat[8],
                        js_this_year_body_fat[9], js_this_year_body_fat[10], js_this_year_body_fat[11]
                    ],
                ...
                {
                    label: '昨年度',
                    data: [js_last_year_body_fat[0], js_last_year_body_fat[1], js_last_year_body_fat[2],
                        js_last_year_body_fat[3], js_last_year_body_fat[4], js_last_year_body_fat[5],
                        js_last_year_body_fat[6], js_last_year_body_fat[7], js_last_year_body_fat[8],
                        js_last_year_body_fat[9], js_last_year_body_fat[10], js_last_year_body_fat[11]
                    ],
