...
<canvas id="canvas"></canvas>
    ...
    <input type="button" onclick="location.href='p_phisical_info_graph_height.php'" value="体重">
    <input type="button" onclick="location.href='p_phisical_info_graph_weight.php'" value="体脂肪率">
