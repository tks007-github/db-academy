...
try {
    ...
    if ($flg) {             // 入力に問題がなかった場合
        ...
        header('Location:c_phisical_test_player_add_done.php');    // p_phisical_test_player_add_done.phpへリダイレクト
        exit();
    } else {                // 入力に問題があった場合
        print '入力に誤りがあります<br><br>';
        print '<input type="button" onclick="location.href=\'c_phisical_test_player_add.php\'" value="戻る">';
    }
} catch (Exception $e) {
    var_dump($e);
    exit();
