...
<body>
    ...
    // m_p_questionnaire.phpから怪我、アレルギー、病気の情報を受け取る
    ...
    <h3>問診表の編集</h3>
    <br>
    <form method="post" action="m_p_questionnaire_edit_done.php">
        怪我<br>
        1.
        名称
        ...
        <br>
        <input type="button" onclick="location.href='m_p_questionnaire.php'" value="戻る">
